// place holder file for the refresh token api for spotify// ahh yeah our callback api also know as getting our access token
...
export default eventHandler(async (event) => {
    ...
    const  {  refreshToken, state }  = await readBody(event);
